package TCPOnlineGame.Control;//класс для работы с клавиатурой (обработка нескольких нажатий одновременно)
...
public class Keyboard implements KeyListener, Serializable {
    ...
    //переменные под каждую из них(только те, которые могут понадобится в разработке на данный момент)
    private boolean a;
    private boolean b;
    private boolean c;
    private boolean d;
